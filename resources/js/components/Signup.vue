        ...
        <div class="col-sm-9">
            ...
            <div class="row"> <!-- Middle Row -->
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <div class=" align-middle">
                            <strong>Password:</strong><b class="text-danger">*</b>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input v-bind:type="[showNewPassword ? 'text' : 'password']"  class="form-control" placeholder="Your password here" v-model="Password" required>
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <div class=" align-middle">
                            <strong>Retype Password:</strong><b class="text-danger">*</b>
                        </div>
                    </div>
                    <div class="row">
                    <div class="col-sm-12 ">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input v-bind:type="[showRetypedPassword ? 'text' : 'password']"  class="form-control" placeholder="Retype password here" v-model="retypePassword" required>
                                <span class="input-group-text" style="background-color: white"  @click="showRetypedPassword = !showRetypedPassword">
                                    <i class="fas" :class="[showRetypedPassword ? 'fa-eye' : 'fa-eye-slash']"></i>
                                </span>
                            </div>
                        </div>
                    </div><!--End Email Subject-->
...
export default {
    ...
    methods:{
        CreateNewAccount(){
            ...
            if(!this.Password)
            {
                this.errors.push("Password is unfilled.");
                this.errorCount++;
            }
            if(!this.retypePassword)
            {
                this.errors.push("Retype Password space is unfilled.");
                this.errorCount++;
            }
            if(this.Password != this.retypePassword)
            {
                this.errors.push("Password and Retype Password do not match.");
                this.errorCount++;
            }
